...
class Worker(WorkerBase):
    ...
    def step_scorer_evaluate_with_hidden_states(self, req_ids, num_scheduled_tokens):
        """Evaluate step scores and return hidden states for mining."""
        return self.model_runner.step_scorer_evaluate_with_hidden_states(
            req_ids, num_scheduled_tokens
        )
    ...
    def sync_sequence_histories(
        ...
        return self.model_runner.sync_sequence_histories(clear_ids, copy_pairs)
