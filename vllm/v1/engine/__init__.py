...
class EngineCoreOutput(
    ...
    # Gambit: Score history for trajectory analysis (list of step-level scores)
...
class EngineCoreOutputs(
    ...
    # Gambit tree export - populated when all requests for a batch complete
    gambit_tree_export: dict | None = None
