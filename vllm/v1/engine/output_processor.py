...
class RequestState:
    ...
    def make_request_output(
        ...
        output = self._new_completion_output(
            new_token_ids, finish_reason, stop_reason, final_score, score_history
        )
    ...
    def _new_completion_output(
        ...
        return CompletionOutput(
            ...
            score_history=score_history if finished else None,
        )
    ...
    def process_outputs(
        ...
        for engine_core_output in engine_core_outputs:
            ...
            if req_state is None:
                # Unknown request (e.g., Gambit branched trace not registered with
                # output processor). Still count tokens for throughput stats.
                if iteration_stats is not None:
                    num_new_tokens = len(engine_core_output.new_token_ids)
                    iteration_stats.num_generation_tokens += num_new_tokens
                continue
            ...
            score_history = engine_core_output.score_history
