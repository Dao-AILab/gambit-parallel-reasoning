...
from .gambit import GambitConfig
...
class VllmConfig:
    ...
    # Gambit config
    gambit_config: GambitConfig = Field(default_factory=GambitConfig)
    ...
    def compute_hash(self) -> str:
        ...
        # Gambit config
        if self.gambit_config:
            vllm_factors.append(self.gambit_config.compute_hash())
